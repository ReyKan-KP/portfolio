      ...
      <div className="container">
        ...
        <div className="max-w-lg mx-auto gap-3">
          ...
          <p className="mt-4 text-center text-white/60 md:text-lg">
            ...
            &nbsp; specializing in <strong>Next.js</strong> and the{" "}
            <strong>MERN stack</strong>, with a focus on creating intuitive and
            engaging frontend experiences. Proficient in
            ...
            <strong>Intellify</strong>, working on dynamic projects using{" "}
            <strong>Next.js</strong>, <strong>TypeScript</strong>,{" "}
            <strong>Supabase</strong>, <strong>Firebase</strong>, and&nbsp;
